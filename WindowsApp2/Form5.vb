...
Public Class Form5
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        Call importToExcel(DataGridView1, "deptrecord.xlsx")
    End Sub

    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        Dim departmentNumber As String = search.Text.Trim()
        Dim strSQL As String = "SELECT DeptID, Department FROM department WHERE DeptID = @DeptID"

        Using connection As MySqlConnection = DBConnection.GetConnection()
            Dim command As New MySqlCommand(strSQL, connection)
            command.Parameters.AddWithValue("@DeptID", departmentNumber)
            ...
            Try
                ...
                If reader.HasRows Then
                    While reader.Read()
                        DeptID.Text = reader.GetString(0)
                        DeptName.Text = reader.GetString(1)
                    End While
                Else
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Dim deptIDValue As String = DeptID.Text.Trim()
        Dim department As String = DeptName.Text.Trim()

        ' Insert the record into the database
        Dim strSQL As String = "INSERT INTO department (DeptID, Department) VALUES (@DeptID, @DeptName)"

        Using connection As MySqlConnection = DBConnection.GetConnection()
            Dim command As New MySqlCommand(strSQL, connection)
            command.Parameters.AddWithValue("@DeptID", deptIDValue)
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Dim strSQL As String = "UPDATE department SET Department = @DeptName WHERE DeptID = @DeptID"
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        Dim strSQL As String = "DELETE FROM department WHERE DeptID = @DeptID"
